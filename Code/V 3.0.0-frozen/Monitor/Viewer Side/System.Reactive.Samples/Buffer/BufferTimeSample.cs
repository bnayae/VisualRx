...
{
    public class BufferTimeSample : SampleBase<IList<int>>
    {
        public override string Title => "Buffer (time)";

        public override double Order => (double)SampleOrder.BufferTime;
...
var ys = xs.Buffer(TimeSpan.FromSeconds(2));
                ";
                return query;
            }
        }
